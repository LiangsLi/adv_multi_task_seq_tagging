...
MODEL_TYPE = 'Model1'
ADV_STATUS = False
DROP_OUT = [0.65, 0.65, 0.65, 0.65]
# DROP_OUT = [1.0, 1.0, 1.0, 1.0]
CORPUS = 9
...
TRAIN_FILE = ['data_msr/train_mt.csv', 'data_as/train_mt.csv', 'data_pku/train_mt.csv', 'data_ctb/train_mt.csv',
              'data_ckip/train_mt.csv', 'data_cityu/train_mt.csv', 'data_ncc/train_mt.csv', 'data_sxu/train_mt.csv',
              'data_weibo/train_mt.csv']
DEV_FILE = ['data_msr/dev_mt.csv', 'data_as/dev_mt.csv', 'data_pku/dev_mt.csv', 'data_ctb/dev_mt.csv',
            'data_ckip/dev_mt.csv', 'data_cityu/dev_mt.csv', 'data_ncc/dev_mt.csv', 'data_sxu/dev_mt.csv',
            'data_weibo/dev_mt.csv']
TEST_FILE = ['data_msr/test_mt.csv', 'data_as/test_mt.csv', 'data_pku/test_mt.csv', 'data_ctb/test_mt.csv',
             'data_ckip/test_mt.csv', 'data_cityu/test_mt.csv', 'data_ncc/test_mt.csv', 'data_sxu/test_mt.csv',
             'data_weibo/test_mt.csv']

DATA_FILE = ['data_msr', 'data_as', 'data_pku', 'data_ctb', 'data_ckip', 'data_cityu', 'data_ncc', 'data_sxu',
             'data_weibo']
MAX_LEN = 80
